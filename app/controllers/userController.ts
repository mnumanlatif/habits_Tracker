...
const createUsers = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
...
const updateUsers = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
...
const deleteUsers = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
